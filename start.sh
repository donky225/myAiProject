...
echo ""
echo -e "${CYAN}==================================================${NC}"
echo -e "${CYAN} 2/4. Stable Diffusion WebUI 기동 (새 창에서 실행됩니다)${NC}"
echo -e "${CYAN}==================================================${NC}"
...
echo ""
echo -e "${CYAN}==================================================${NC}"
echo -e "${CYAN} 3/4. 음성 파이프라인 서버(STT/TTS) 기동 (새 창에서 실행됩니다)${NC}"
echo -e "${CYAN}==================================================${NC}"
...
echo ""
echo -e "${CYAN}==================================================${NC}"
echo -e "${CYAN} 4/4. 리랭크 서버(RAG 재정렬, BAAI/bge-reranker-v2-m3) 기동 (새 창에서 실행됩니다)${NC}"
echo -e "${CYAN}==================================================${NC}"
